...
public class TicketDeleteNWBladeItem extends TicketsTestBase {
	/*
	 ...
	 * */
	@Test
	public final void testCreateNWBladeItemWithTickets() throws Throwable {
		
		// Create dummy blade server item
		ItItem nwBladeItem = createNewTestNetworkBlade("UNITTEST-TICKET-NW-BLADE", null);
		...
		Long newItemId = testNewItemWithTicket(nwBladeItem, errorCodes, 105L);
	...
	Ticket Archived 
	*/
	private void testDeleteNWBladeItemInTicketStatus(Long testTicketStatus, Long uniqueClassMountingFF) throws Throwable {
		...
		// 5. verify the origin field
		List<String> errorCodes = new ArrayList<String>();
		Long newItemId = testNewItemWithTicket(nwBladeItem, errorCodes, uniqueClassMountingFF);
	...
	public final void testDeleteItemInTicketReceived() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 105L);
	}

	@Test
	public final void testDeleteItemInTicketUpdated() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.UPDATED, 105L);
	}

	@Test
	public final void testDeleteItemInTicketIncomplete() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.INCOMPLETE, 105L);
	}

	@Test
	public final void testDeleteItemInTicketRequestIssued() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.REQUEST_ISSUED, 105L);
	}
	
	@Test
	public final void testModTicketDataForVM() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 100L);
	}
	...
	public final void testModTicketDataForInvalidItem() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, -1L);
	}

	@Test
	public final void testModTicketDataForDevBladeChassis() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 104L);
	}
	
	@Test
	public final void testModTicketDataForDevRackFixed() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 101L);
	}
	
	@Test
	public final void testModTicketDataForDevFSFixed() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 103L);
	}

	@Test
	public final void testModTicketDataForNwBlade() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 205L);
	}

	@Test
	public final void testModTicketDataForNwChassis() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 204L);
	}

	@Test
	public final void testModTicketDataForNwFsFixed() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 203L);
	}
	
	@Test
	public final void testModTicketDataForNwRackFixed() throws Throwable {
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 201L);
	}

	@Test
	public final void testModTicketDataForRpduZuFixed() throws Throwable { 
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 506L);
	}
	
	@Test
	public final void testModTicketDataForRpduRackFixed() throws Throwable { 
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 501L);
	}

	@Test
	public final void testModTicketDataForCabFs() throws Throwable { // failed
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 603L);
	}
	
	@Test
	public final void testModTicketDataForCabFsContainer() throws Throwable { // failed
		testDeleteNWBladeItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 613L);
	}
