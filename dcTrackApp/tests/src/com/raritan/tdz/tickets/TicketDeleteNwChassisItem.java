...
public class TicketDeleteNwChassisItem extends TicketsTestBase {
	/*
	...
	public final void testCreateDevChassisItemWithTickets() throws Throwable {
		...
		// Create dummy chassis item
		ItItem nwChassisItem = createNewTestNetworkChassis("UNITTEST-TICKET-NW-CHASSIS");
		...
		Long newItemId = testNewItemWithTicket(nwChassisItem, errorCodes, 105L);
	...
	*/
	private void testDeleteDevChassisItemInTicketStatus(Long testTicketStatus, Long uniqueClassMountingFF) throws Throwable {
		...
		// 5. verify the origin field
		List<String> errorCodes = new ArrayList<String>();
		Long newItemId = testNewItemWithTicket(nwChassisItem, errorCodes, uniqueClassMountingFF);
