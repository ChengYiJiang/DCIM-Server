...
public class TicketDeleteDevVMItem extends TicketsTestBase {
	/*
	...
	public final void testCreateBladeServerItemWithTickets() throws Throwable {
		...
		// Create dummy VM item
		ItItem devVMItem = createNewTestDeviceVM("UNITTEST-TICKET-VM");
		...
		Long newItemId = testNewItemWithTicket(devVMItem, errorCodes, 105L);
	...
	*/
	private void testDeleteBladeServerItemInTicketStatus(Long testTicketStatus, Long uniqueClassMountingFF) throws Throwable {
		...
		// 5. verify the origin field
		List<String> errorCodes = new ArrayList<String>();
		Long newItemId = testNewItemWithTicket(devVMItem, errorCodes, uniqueClassMountingFF);
