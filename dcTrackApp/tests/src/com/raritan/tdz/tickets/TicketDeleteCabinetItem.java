...
// createNewTestCabinet
public class TicketDeleteCabinetItem extends TicketsTestBase {
	/*
	...
	public final void testCreateBladeServerItemWithTickets() throws Throwable {
		...
		CabinetItem cabinetItem = createNewTestCabinet("UNITTEST-TICKET-CABINET", null);
		...
		Long newItemId = testNewItemWithTicket(cabinetItem, errorCodes, 105L);
	...
	*/
	private void testDeleteBladeServerItemInTicketStatus(Long testTicketStatus, Long uniqueClassMountingFF) throws Throwable {
		...
		// 5. verify the origin field
		List<String> errorCodes = new ArrayList<String>();
		Long newItemId = testNewItemWithTicket(cabinetItem, errorCodes, uniqueClassMountingFF);
