...
public class TicketDeleteDevRackFixedItem extends TicketsTestBase {
	/*
	 ...
	 * */
	@Test
	public final void testCreateDevRackableFixedItemWithTickets() throws Throwable {
		
		// Create dummy blade server item
		Item devRackFixedItem = createNewTestDevice("UNITTEST-TICKET-DEV-CHASSIS", SystemLookup.ItemStatus.PLANNED);
		...
		Long newItemId = testNewItemWithTicket(devRackFixedItem, errorCodes, 105L);
	...
	Ticket Archived 
	*/
	private void testDeleteDevRackableFixedItemInTicketStatus(Long testTicketStatus, Long uniqueClassMountingFF) throws Throwable {
		...
		// 5. verify the origin field
		List<String> errorCodes = new ArrayList<String>();
		Long newItemId = testNewItemWithTicket(devRackFixedItem, errorCodes, uniqueClassMountingFF);
	...
	public final void testDeleteItemInTicketReceived() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 105L);
	}

	@Test
	public final void testDeleteItemInTicketUpdated() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.UPDATED, 105L);
	}

	@Test
	public final void testDeleteItemInTicketIncomplete() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.INCOMPLETE, 105L);
	}

	@Test
	public final void testDeleteItemInTicketRequestIssued() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.REQUEST_ISSUED, 105L);
	}
	
	@Test
	public final void testModTicketDataForVM() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 100L);
	}
	...
	public final void testModTicketDataForInvalidItem() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, -1L);
	}

	@Test
	public final void testModTicketDataForDevBladeChassis() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 104L);
	}
	
	@Test
	public final void testModTicketDataForDevRackFixed() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 101L);
	}
	
	@Test
	public final void testModTicketDataForDevFSFixed() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 103L);
	}

	@Test
	public final void testModTicketDataForNwBlade() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 205L);
	}

	@Test
	public final void testModTicketDataForNwChassis() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 204L);
	}

	@Test
	public final void testModTicketDataForNwFsFixed() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 203L);
	}
	
	@Test
	public final void testModTicketDataForNwRackFixed() throws Throwable {
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 201L);
	}

	@Test
	public final void testModTicketDataForRpduZuFixed() throws Throwable { 
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 506L);
	}
	
	@Test
	public final void testModTicketDataForRpduRackFixed() throws Throwable { 
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 501L);
	}

	@Test
	public final void testModTicketDataForCabFs() throws Throwable { // failed
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 603L);
	}
	
	@Test
	public final void testModTicketDataForCabFsContainer() throws Throwable { // failed
		testDeleteDevRackableFixedItemInTicketStatus(SystemLookup.TicketStatus.RECEIVED, 613L);
	}
