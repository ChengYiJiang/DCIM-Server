...
public class TicketDeleteDevChassisItem extends TicketsTestBase {
	/*
	...
	public final void testCreateDevChassisItemWithTickets() throws Throwable {
		...
		ItItem devDevChassisItem = createNewTestDeviceChassis("UNITTEST-TICKET-DEV-CHASSIS");
		...
		Long newItemId = testNewItemWithTicket(devDevChassisItem, errorCodes, 105L);
	...
	*/
	private void testDeleteDevChassisItemInTicketStatus(Long testTicketStatus, Long uniqueClassMountingFF) throws Throwable {
		...
		// 5. verify the origin field
		List<String> errorCodes = new ArrayList<String>();
		Long newItemId = testNewItemWithTicket(devDevChassisItem, errorCodes, uniqueClassMountingFF);
