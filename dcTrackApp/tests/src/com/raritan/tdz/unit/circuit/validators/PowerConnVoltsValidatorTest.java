...
import com.raritan.tdz.circuit.validators.PowerConnVoltsValidator;
 ...
 *
 */
public class PowerConnVoltsValidatorTest extends UnitTestBase {
	
	@Autowired
	private PowerConnVoltsValidator powerConnValidator;
	...
	public void testIncompatibleVolts(){
		...
		final LksData voltsLksSrc = new LksData();
		final LksData voltsLksDst = new LksData();
		
		voltsLksSrc.setLksId(10L);
		voltsLksSrc.setLkpValue("120~240");
		voltsLksSrc.setLksId(11L);
		voltsLksDst.setLkpValue("30");
		...
		srcPowerPortDB.setVoltsLookup(voltsLksSrc);
		
		dstPowerPortDB.setPortId(dstPortId);
		dstPowerPortDB.setVoltsLookup(voltsLksDst);
	...
	@Test
	public void testCompatibleVolts120T240_110(){
		final long srcPortId = idGenerator.nextId();
		final long dstPortId = idGenerator.nextId();
	...
	@Test
	public void testCompatibleVolts120_110(){
		final long srcPortId = idGenerator.nextId();
		final long dstPortId = idGenerator.nextId();
	...
	@Test
	public void testCompatibleVolts240_260(){
		final long srcPortId = idGenerator.nextId();
		final long dstPortId = idGenerator.nextId();
		...
		voltsLksSrc.setLksId(10L);
		voltsLksSrc.setLkpValue("240");
		voltsLksSrc.setLksId(11L);
		voltsLksDst.setLkpValue("260");
