...
public class UpdateChildrenRequestComments implements RequestStageHelper {
	...
	public void update(Request request, Long requestStage, UserInfo userInfo)
		...
		Errors childReqErrors = itemMoveHelper.getChildrenRequestErrors(request.getItemId(), errors);
