 ...
 * @author Randy Chen
 */
public class BudgetedAmpsPerCabinetReport extends ReportHomeBase implements ReportHome {

	public BudgetedAmpsPerCabinetReport(SessionFactory sessionFactory ){
		super(sessionFactory);
		log.info("BudgetedAmpsPerCabinetReport init...");
