 ...
 * @author Randy Chen
 */
public class MaxTemperaturePerCabinetRearsReport extends ReportHomeBase implements ReportHome {

	public MaxTemperaturePerCabinetRearsReport(SessionFactory sessionFactory ){
		super(sessionFactory);
		log.info("MaxTemperaturePerCabinetRearsReport init...");
	...
	public ReportDataDTO getReportData(String reportType,String locationCode,String filterType,String filterValue) throws DataAccessException {
		...
		String querySQL=
			...
			"sensor.cab_loc_lks_id in (951, 953, 955) "+ //-- use for Rear Top / Mid / Bottom
