 ...
 *
 */
public class UserContextRouterImpl implements
		UserContextRouter, ApplicationContextAware, DCTrackUserLogoutEventHandler {
	
	public static String USER_UUID_PROPERTY = "UserUUIDProperty";
	private static String propertiesName = "UserProps";
	...
	public UserContextRouterImpl(String springContextPath, String channelName){
	...
	private void setEnvironment(ConfigurableApplicationContext ctx, String uuid){
		...
		props.setProperty(USER_UUID_PROPERTY, uuid);
