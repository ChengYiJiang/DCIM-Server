 ...
 *
 */
public class DataPortValidator implements Validator {
	@Autowired
	...
	public void validate(Object target, Errors errors) {
		...
		IPortObjectCollection dataPortObjects = portObjectsFactory.getPortObjects(classMountingFormFactorValue, "DataPorts", item, errors);
		
		dataPortObjects.validate(errors);
