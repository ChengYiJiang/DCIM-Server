 ...
 *
 */
public class ItemStatusEditability implements RulesNodeEditability {
	...
	ItemStatusEditability(Map<String,Boolean> editabilityMap){
		this.editabilityMap = editabilityMap;
	}
	
	/* (non-Javadoc)
	 * @see com.raritan.tdz.rulesengine.RulesNodeEditability#setNodeEditable(com.raritan.dctrack.xsd.DcTrack, java.lang.Boolean)
	 */
	@Override
