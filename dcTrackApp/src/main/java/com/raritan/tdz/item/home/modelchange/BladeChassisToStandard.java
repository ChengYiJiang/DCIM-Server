 ...
 *
 */
public class BladeChassisToStandard implements ChangeModel {

	ChangeModelDAO changeModelDAO;
	
	Logger log = Logger.getLogger(ChangeModel.class);
	
	public BladeChassisToStandard(ChangeModelDAO changeModelDAO) {
	...
	public void change(Item itemInDB, Item itemToSave)
		...
		log.debug("Changing from BladeChassis To Standard");
