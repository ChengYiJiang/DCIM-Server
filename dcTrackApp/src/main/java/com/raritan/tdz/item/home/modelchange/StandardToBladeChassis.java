 ...
 *
 */
public class StandardToBladeChassis implements ChangeModel {

	ChangeModelDAO changeModelDAO;
	Logger log = Logger.getLogger(ChangeModel.class);
	
	public StandardToBladeChassis(ChangeModelDAO changeModelDAO) {
	...
	public void change(Item itemInDB, Item itemToSave)
		...
		log.debug("Standard To BladeChassis");
