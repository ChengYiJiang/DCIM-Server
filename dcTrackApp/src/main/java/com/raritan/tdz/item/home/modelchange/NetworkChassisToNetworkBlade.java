 ...
 *
 */
public class NetworkChassisToNetworkBlade implements ChangeModel {

	ChangeModelDAO changeModelDAO;
	Logger log = Logger.getLogger(ChangeModel.class);
	
	public NetworkChassisToNetworkBlade(ChangeModelDAO changeModelDAO) {
	...
	public void change(Item itemInDB, Item itemToSave)
		...
		log.debug("Changing NetworkChassis To NetworkBlade");
