 ...
 *
 */
public class NetworkBladeToNetworkChassis implements ChangeModel {

	ChangeModelDAO changeModelDAO;
	Logger log = Logger.getLogger(ChangeModel.class);
	
	public NetworkBladeToNetworkChassis(ChangeModelDAO changeModelDAO) {
	...
	public void change(Item itemInDB, Item itemToSave)
		...
		log.debug("Changing NetworkBlade To NetworkChassis");
