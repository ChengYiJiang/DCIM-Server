 ...
 *
 */
public class SensorPortValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		IPortObjectCollection sensorPortObjects = portObjectsFactory.getPortObjects(classMountingFormFactorValue, "SensorPorts", item, errors);
		
		sensorPortObjects.validate(errors);
	}
