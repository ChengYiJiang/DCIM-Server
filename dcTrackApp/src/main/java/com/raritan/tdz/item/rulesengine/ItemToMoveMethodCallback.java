...
public class ItemToMoveMethodCallback implements RemoteRefMethodCallback {
	...
	public void fillValue(UiComponent uiViewComponent, String filterField,
		...
		Long movedItemId = powerPortMoveDAO.getMovingItemId((Long)filterValue);
		
		uiViewComponent.getUiValueIdField().setValue(movedItemId);
