...
/**
 * Blade Item implementation.
 * @author Bunty Nasta
 */
public class BladeItemImpl extends ItItemObject implements BladeItem {
	...
	public BladeItemImpl(SessionFactory sessionFactory) {
