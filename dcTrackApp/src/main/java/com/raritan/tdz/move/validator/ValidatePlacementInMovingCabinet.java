...
public class ValidatePlacementInMovingCabinet implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		Errors placementErrors = itemMoveHelper.getPlacementInMoveCabinetError(item, errors, false);
		...
		errors.rejectValue("itemMove", "ItemMoveValidator.placeItemInMovingCabinet", errorArgs, errorMsg.toString());
