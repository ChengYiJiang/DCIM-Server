...
public class PlacementCabinetRailsUsedTicketSaveBehavior implements
		TicketSaveBehavior {
	...
	public void updateTicketFields(Object fields, Item item) {
		...
		if (null == railsUsed) {
			ticketFields.setRailsUsed(null);
			
			ticketFields.setRailsUsedId(null);
			
		}
		else {
		
			ticketFields.setRailsUsed(railsUsed.getLkpValue());
			
			ticketFields.setRailsUsedId(railsUsed);
		}
